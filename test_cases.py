...
def main():
    ...
    g_filter_raster = Raster(footprint=full_fp,
        dtype='float32',
    ...
    m_filter_raster = Raster(footprint=full_fp,
        dtype='float32',
    ...
    summed_raster = Raster(footprint=full_fp,
        dtype='float32',
    ...
    sobel_raster = Raster(footprint=full_fp,
        dtype='float32',
    ...
    dot_raster = sobel_raster = Raster(footprint=full_fp,
        dtype='float32',
    ...
    tiles = full_fp.tile_count(15,15)
